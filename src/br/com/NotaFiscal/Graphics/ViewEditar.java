...
public class ViewEditar extends Main{
		
		public void exibirEditar(NotaFiscal i, Event<NotaFiscal> event){
			...
			CnpjCpf.setText(""+i.getDestinatario().getCnpjCpf());
			filho3.add(CnpjCpf);
			//RAZÃO SOCIAL
			filho3.add((new JLabel(" Razão social/Nome: ")));
			JTextField nome = new JTextField(14);
			nome.setText(""+i.getDestinatario().getSocialNome());
			filho3.add(nome);
			...
			inscri.setText(""+i.getEmitende().getInscricao());
			filho4.add(inscri);
			//ESTADO
			filho4.add((new JLabel(" Estado: ")));
			JTextField estado = new JTextField(10);
			estado.setText(""+i.getEmitende().getEstado());
			filho4.add(estado);
			//QNT ITENS
...
//			filho4.add(valor);
			...
			//PAINEL 3
					...
					CnpjCpf1.setText(""+i.getEmitende().getCnpjCpf());
					filho7.add(CnpjCpf1);
					//RAZÃO SOCIAL
					filho7.add((new JLabel(" Razão social/Nome: ")));
					JTextField nome1 = new JTextField(14);
					nome1.setText(""+i.getEmitende().getSocialNome());
					filho7.add(nome1);
					...
					inscri1.setText(""+i.getDestinatario().getInscricao());
					filho8.add(inscri1);
					//ESTADO
					filho8.add((new JLabel(" Estado: ")));
					JTextField estado1 = new JTextField(10);
					estado1.setText(""+i.getDestinatario().getEstado());
					filho8.add(estado1);
					//QNT ITENS
			...
			salvar.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					System.out.println(codigo.getText().length());
					System.out.println(desc.getText().length());
					System.out.println(natu.getText().length());
					System.out.println(CnpjCpf.getText().length());
					System.out.println(CnpjCpf1.getText().length());
					System.out.println(nome.getText().length());
					System.out.println(nome1.getText().length());
					System.out.println(inscri.getText().length());
					System.out.println(inscri1.getText().length());
					System.out.println(estado.getText().length());
					System.out.println(estado1.getText().length());
					System.out.println(qntItens.getText().length());
					System.out.println(precoItem.getText().length());
...
//					  ||(precoItem.getText().length() == 0)
				...
				editar.add(painel);
				editar.setExtendedState(Frame.MAXIMIZED_BOTH);
			}
}
